...
from .my_llama_debug_lwf import LlamaForCausalLM
...
class LlavaLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        # pure_text_index = [i for i, label in enumerate(labels) if (label != -100).sum() > 10]
        # multi_modal_index = [i for i in range(len(labels)) if i not in pure_text_index]
