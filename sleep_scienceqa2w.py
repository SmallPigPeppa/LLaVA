...
# Load OCR data
with open('playground/data/fine-tune/ScienceQA/train.json', 'r') as f:
...
selected_others_data = random.sample(others_data, 20000)
...
with open('playground/data/fine-tune/ScienceQA/train-with-others-20000.json', 'w') as f:
