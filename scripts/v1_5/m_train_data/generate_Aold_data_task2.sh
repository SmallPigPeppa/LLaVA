...
python -m llava.eval.model_vqa_generate_Aold \
    ...
    --dataset-file ./playground/data/data-incremental/llava_v1_5_mix665k-task2.json \
    --output-file ./playground/data/data-incremental/llava_v1_5_mix665k-task2-Aold-no.json \
    --conv-mode llava_v1
