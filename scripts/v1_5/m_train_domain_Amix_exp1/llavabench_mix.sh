...
MODEL="llava-v1.5-7b-lora-task-gqa-merged-exp1-ratio0.05"
...
OUT_PATH="continual-ckpt/exp1/llava-v1.5-7b-lora-task-gqa-merged-exp1-ratio0.05"

python -m llava.eval.model_vqa_save_weight_hf_mix \
  --model-path ${MODEL_PATH} \
  --model-base ${MODEL_BASE} \
  --save-path ${OUT_PATH} \
  --lora-scale-factor 0.05
