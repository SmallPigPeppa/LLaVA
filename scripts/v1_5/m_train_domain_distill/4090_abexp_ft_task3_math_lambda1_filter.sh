...
DATA_PATH="playground/data/fine-tune/CLEVR-Math/train_4w-filter-with-others.json"
OUTPUT_DIR="finetune-ckpt/llava-c/llava-v1.5-7b-lora-task3-math-lambda1.0-filter"
