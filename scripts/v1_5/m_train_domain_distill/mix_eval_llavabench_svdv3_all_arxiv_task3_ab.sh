...
MODEL_PATH_A1="finetune-ckpt/llava-c/llava-v1.5-7b-lora-task2-super-lambda1.0-merged-mix0.12-svdv3"
MODEL_PATH_B1="finetune-ckpt/llava-c/llava-v1.5-7b-lora-task3-arxiv-lambda1.0-ablation-merged"
