...
DATA_PATH="playground/data/domain-incremental-mse/coco-with-othersv4-llama.json"
OUTPUT_DIR="continual-ckpt/domain-incremental-mse/llava-v1.5-7b-lora-task-coco-v4-lambda1.0-llama"
