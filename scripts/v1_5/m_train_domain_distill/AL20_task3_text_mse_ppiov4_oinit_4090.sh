...
MODEL_PATH="continual-ckpt/domain-incremental-mse/llava-v1.5-7b-lora-task-ocr-oinit-lambda1.0-merged"
DATA_PATH="playground/data/domain-incremental-mse/textvqa-with-others.json"
OUTPUT_DIR="continual-ckpt/domain-incremental-mse/llava-v1.5-7b-lora-task-textvqa-oinit-lambda1.0"
