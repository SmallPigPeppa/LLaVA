...
DATA_PATH="playground/data/domain-incremental-mse/coco-with-othersv2.json"
OUTPUT_DIR="continual-ckpt/domain-incremental-mse/llava-v1.5-7b-lora-task-coco-v2"
