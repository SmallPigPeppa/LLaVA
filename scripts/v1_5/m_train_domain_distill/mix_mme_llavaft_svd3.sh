...
MODEL_PATH_B="continual-ckpt/domain/llava-v1.5-7b-lora-task-ocr_vqa-merged"
MODEL_PATH_B="continual-ckpt/domain/llava-v1.5-7b-lora-task-ocr_vqa-lambda1.0-merged"
