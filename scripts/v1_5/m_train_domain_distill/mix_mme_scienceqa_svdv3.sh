...
MODEL_PATH_B="finetune-ckpt/fine-tune/llava-v1.5-7b-lora-scienceqa-merged"
#MODEL_PATH_B="finetune-ckpt/fine-tune/llava-v1.5-7b-lora-scienceqa-lambda1.0-merged"
