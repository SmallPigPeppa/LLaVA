...
python -m llava.eval.model_vqa_loader \
    ...
    --answers-file ./playground/data/eval/MME/answers/llava-v1.5-7b-lora-task-others-merged.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1

cd ./playground/data/eval/MME

python convert_answer_to_mme.py --experiment llava-v1.5-7b-lora-task-others-merged

cd eval_tool

python calculation.py --results_dir answers/llava-v1.5-7b-lora-task-others-merged
