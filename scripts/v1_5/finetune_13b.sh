...
deepspeed llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter /mnt/bn/liuwenzhuo-lf/ckpt/llava-v1.5-13b-pretrain/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir  /mnt/bn/liuwenzhuo-lf/ckpt/llava-v1.5-13b-finetune \
    --num_train_epochs 1 \
