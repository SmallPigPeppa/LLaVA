...
with open('playground/data/domain-incremental-mse/llava_v1_5_mix665k-others-llama.json', 'r') as f:
...
# 保存为新的文件
output_file = 'playground/data/domain-incremental-mse/coco-with-othersv4-llama.json'
